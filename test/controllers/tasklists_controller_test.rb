...
class TasklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tasklist" do
    assert_difference("Tasklist.count") do
      post tasklists_url, params: { tasklist: { duedate: @tasklist.duedate, status: @tasklist.status, task: @tasklist.task } }
    end
  ...
  test "should update tasklist" do
    patch tasklist_url(@tasklist), params: { tasklist: { duedate: @tasklist.duedate, status: @tasklist.status, task: @tasklist.task } }
